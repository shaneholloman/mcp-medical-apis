...
async def opentargets_search(
    ...
    try:
        return await opentargets_client.search(query=query, entity=entity, size=size)
...
async def opentargets_get_associations(
    ...
    try:
        return await opentargets_client.get_associations(
...
async def opentargets_get_evidence(
    ...
    try:
        return await opentargets_client.get_evidence(
            target_id=target_id, disease_id=disease_id, size=size
        )
    except Exception as e:  # pragma: no cover - defensive
