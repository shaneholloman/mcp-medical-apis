...
def validate_response(
    ...
    try:
        ...
        logger.debug(f"Validated {api_name} response structure{f' for {context}' if context else ''}")
        ...
        logger.error(f"{api_name} response validation failed{f' for {context}' if context else ''}: {ve}")
